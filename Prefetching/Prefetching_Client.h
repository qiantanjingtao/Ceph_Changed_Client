...
static Point hot = {440705, 440705, 440708, 440707};
// hot.atime = 440705; hot.btime = 440705; hot.ctime = 440708; hot.mtime = 440707;
...
protected:
  ...
  //changed
  void check_prefetch(Dentry* dn, const UserPerm& perms); 
  void record(Inode *in, Dentry *dn);
  // trim cache.
 ...
 public:
  ...
  Client(Messenger *m, MonClient *mc, Objecter *objecter_, ceph::unordered_map <string, list<utime_t>> dentry_list);
...
#define CHECK_CAPS_SYNCHRONOUS	(0x2)
  ...
  Dentry *insert_dentry_inode(Dir *dir, const string& dname, LeaseStat *dlease, 
			      ...
			      const UserPerm& request_perms, Dentry *old_dentry = NULL);
...
{
  public:
  StandaloneClient(Messenger *m, MonClient *mc, ceph::unordered_map <string, list<utime_t>> dentry_list);
